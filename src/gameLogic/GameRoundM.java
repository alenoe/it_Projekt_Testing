...
public class GameRoundM implements Observer{
	...
	public static final int MAX_PLAYERS = 2; // Wenn man mehr als 2 Spieler will, w�re es n�tzlich hier "MAX_PLAYERS = players.size()" 
	...
	// Wenn ein Spieler rausfliegt, kann man ihn dann einfach von dieser Liste l�schen und die ArrayList-Size nochmal einlesen.
