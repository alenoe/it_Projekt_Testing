...
public class GameM implements Observer, Serializable{
	...
	public GameM(PlayerInGameM player1, PlayerInGameM player2){
		...
		this.rounds = 0;
		// Hier k�nnte man noch eine Variable setzen anhand der dann das GUI erkennt: 
		...
		// Man kann bei den Injections auch direkt Methoden, if-Abfragen und co. machen. W�hrend des Initializable und w�hrend das Programm bereits l�uft
		// - Kommentar von R
	...
	public GameM(PlayerInGameM player1, PlayerInGameM player2, PlayerInGameM player3){
		...
		this.rounds = 0;
		// Hier k�nnte man noch eine Variable setzen anhand der dann das GUI erkennt: "AH! Ich muss Spieler-Feld 1, 2 und 3 laden!"
	...
	public GameM(PlayerInGameM player1, PlayerInGameM player2, PlayerInGameM player3, PlayerInGameM player4){
		...
		this.rounds = 0;
		// Hier k�nnte man noch eine Variable setzen anhand der dann das GUI erkennt: "AH! Ich muss Spieler-Feld 1, 2, 3 und 4 laden!"
